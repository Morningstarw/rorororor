...
function showMessage(response) {
    if (response === "No") {
        ...
        if(noClickCount <= 5){
            ...
            questionElement.textContent =  "Okay Pookie, sorry for insisting so much. Of course I respect your boundaries and I'm sorry if I was being too pushy. I will wait for us to bati! Mwa!!"
    ...
    if (response === "Yes") {
        ...
        yesMessage.textContent = "YESSSSS, I LOVE YOU!!";
